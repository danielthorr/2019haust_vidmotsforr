...
function drawScene(gl, programInfo, buffers) {
    ...
    // the display size of the canvas and we only want to see objects between
    // 0.1 units and 100 units away from the camera.
    ...
    // Set the drawing position to the "identity" point which is center of the scene
    ...
    // Tell WebGL how to get the positions from the position buffer 
